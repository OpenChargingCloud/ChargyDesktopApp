...
class EMHCrypt01 extends ACrypt {
    ...
    Calc(measurementValue:  IMeasurementValue): IEMHCrypt01Result
    {
        ...
        var cryptoData:IEMHCrypt01Result = {
            ...
            infoStatusDiv:                SetHex      (cryptoBuffer, measurementValue["additionalInfo"]["status"],                          14, false),
            indexesTimer:                 SetTimestamp(cryptoBuffer, measurementValue["additionalInfo"].indexes.timer,                      15),
            ...
            logBook:                      SetHex      (cryptoBuffer, measurementValue["additionalInfo"].indexes.logBook,                    39, true),
         ...
         signatureCheckValue:     HTMLDivElement)
    {
        ...
        var cryptoValueDiv                  = CreateDiv(cryptoDiv,              "value",  EMHCrypt01.name + " (" + this.description + ")");
        ...
        this.AddToBuffer(result.infoStatusDiv,           bufferValue, addInfoStatusDiv);
