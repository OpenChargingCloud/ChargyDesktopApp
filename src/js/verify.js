...
function StartDashboard() {
    ...
    function ViewGDFCrypt01(measurementValue, infoDiv, bufferValue, hashedBufferValue, publicKeyValue, signatureExpectedValue, signatureCalculatedValue) {
        var buffer = new ArrayBuffer(320);
        var view = new DataView(buffer);
        ...
        if (meter != null) {
            ...
            if (publicKey != null) {
                //var el      = require('electron').remote.require(__dirname + '\\js\\crypto\\elliptic.js');
                ...
                signatureCalculatedValue.innerHTML = "0x" + result;
                console.log(result);
            }
            else
    ...
    function ShowMeasurementCryptoDetails(measurementValue) {
        ...
        var signatureCalculatedValue = overlayDiv.querySelector('#signatureCalculated .value');
        infoDiv.innerHTML = '';
        ...
        ViewGDFCrypt01(measurementValue, infoDiv, bufferValue, hashedBufferValue, publicKeyValue, signatureExpectedValue, signatureCalculatedValue);
    }
