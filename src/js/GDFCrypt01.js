...
class GDFCrypt01 extends ACrypt {
    constructor(chargy) {
        super("ECC secp256r1", chargy);
        this.curve = new this.chargy.elliptic.ec('p256');
    }
    GenerateKeyPair() {
    ...
    async ViewMeasurement(measurementValue, introDiv, infoDiv, bufferValue, hashedBufferValue, publicKeyValue, signatureExpectedValue, signatureCheckValue) {
...
//# sourceMappingURL=GDFCrypt01.js.map