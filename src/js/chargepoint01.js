...
class Chargepoint01 {
    ...
    async tryToParseChargepointJSON(SomeJSON) {
        try {
...
class ChargepointCrypt01 extends ACrypt {
    constructor(chargy) {
        super("ECC secp224k1/secp256r1", chargy);
    ...
    async VerifyChargingSession(chargingSession) {
        ...
        try {
            ...
            if (chargingSession.ctr.publicKeys != null) {
                for (let publicKeyInfo of (_a = chargingSession.ctr) === null || _a === void 0 ? void 0 : _a.publicKeys) {
            ...
            if (chargingSession.publicKey != null &&
                ...
                switch (chargingSession.publicKey.curve.description) {
                    case "secp224k1":
                        ...
                        sessionResult = this.curve224k1.validate(BigInt("0x" + chargingSession.hashValue), BigInt("0x" + chargingSession.signature.r), BigInt("0x" + chargingSession.signature.s), [BigInt("0x" + chargingSession.publicKey.value.substr(2, 56)),
                    ...
                    case "secp256r1":
                        ...
                        sessionResult = this.curve256r1.keyFromPublic(chargingSession.publicKey.value, 'hex').
                            verify(chargingSession.hashValue, chargingSession.signature)
                            ? SessionVerificationResult.ValidSignature
                            : SessionVerificationResult.InvalidSignature;
                        break;
                    case "secp384r1":
    ...
    async ViewMeasurement(measurementValue, introDiv, infoDiv, PlainTextDiv, HashedPlainTextDiv, PublicKeyDiv, SignatureExpectedDiv, SignatureCheckDiv) {
        ...
        let chargingSession = (_a = measurementValue === null || measurementValue === void 0 ? void 0 : measurementValue.measurement) === null || _a === void 0 ? void 0 : _a.chargingSession;
        let result = measurementValue.result;
        let cryptoAlgorithm = ((_b = chargingSession === null || chargingSession === void 0 ? void 0 : chargingSession.publicKey) === null || _b === void 0 ? void 0 : _b.curve.description) != null
            ? " (" + ((_c = chargingSession === null || chargingSession === void 0 ? void 0 : chargingSession.publicKey) === null || _c === void 0 ? void 0 : _c.curve.description) + ")"
            : "";
        let cryptoSpan = introDiv === null || introDiv === void 0 ? void 0 : introDiv.querySelector('#cryptoAlgorithm');
        ...
        if (PlainTextDiv != null) {
            ...
            PlainTextDiv.innerText = atob((_d = chargingSession.original) !== null && _d !== void 0 ? _d : "");
        ...
        if (HashedPlainTextDiv != null) {
            let hashInfo = "";
            switch ((_e = chargingSession.publicKey) === null || _e === void 0 ? void 0 : _e.curve.description) {
                case "secp224k1":
            ...
            HashedPlainTextDiv.innerHTML = (_h = (_g = (_f = chargingSession.hashValue) === null || _f === void 0 ? void 0 : _f.match(/.{1,8}/g)) === null || _g === void 0 ? void 0 : _g.join(" ")) !== null && _h !== void 0 ? _h : "0x00000000000000000000000000000000000";
        }
        //#endregion
        //#region Public Key
        ...
        if (SignatureExpectedDiv != null && chargingSession.signature != null) {
            ...
            if (typeof chargingSession.signature != 'string')
                SignatureExpectedDiv.innerHTML = "r: " + ((_j = chargingSession.signature.r.toLowerCase().padStart(56, '0').match(/.{1,8}/g)) === null || _j === void 0 ? void 0 : _j.join(" ")) + "<br />" +
                    "s: " + ((_k = chargingSession.signature.s.toLowerCase().padStart(56, '0').match(/.{1,8}/g)) === null || _k === void 0 ? void 0 : _k.join(" "));
            else if (chargingSession.signature)
                SignatureExpectedDiv.innerHTML = (_m = (_l = chargingSession.signature.toLowerCase().match(/.{1,8}/g)) === null || _l === void 0 ? void 0 : _l.join(" ")) !== null && _m !== void 0 ? _m : "-";
        }
        //#endregion
...
//# sourceMappingURL=chargePoint01.js.map