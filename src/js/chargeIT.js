...
class ChargeIT {
    ...
    async tryToParseChargeITJSON(SomeJSON) {
        ...
        try {
            ...
            for (let i = 0; i < signedMeterValues.length; i++) {
                ...
                let _meterInfo_publicKey = _meterInfo["publicKey"];
                ...
                let _contract_type = _contract["type"];
                ...
                let _contract_timestampLocal_timestamp = _contract_timestampLocal["timestamp"];
                ...
                let _contract_timestampLocal_localOffset = _contract_timestampLocal["localOffset"];
                ...
                let _contract_timestampLocal_seasonOffset = _contract_timestampLocal["seasonOffset"];
                ...
                let _measuredValue_timestampLocal_timestamp = _measuredValue_timestampLocal["timestamp"];
                ...
                let _measuredValue_timestampLocal_localOffset = _measuredValue_timestampLocal["localOffset"];
                ...
                let _measuredValue_timestampLocal_seasonOffset = _measuredValue_timestampLocal["seasonOffset"];
                ...
                let _measuredValue_unitEncoded = _measuredValue["unitEncoded"];
                ...
                let _additionalInfo_indexes_timer = _additionalInfo_indexes["timer"];
                ...
                let _additionalInfo_indexes_logBook = _additionalInfo_indexes["logBook"];
                ...
                let _additionalInfo_status = _additionalInfo["status"];
                ...
                let _signature = signedMeterValue["signature"];
                ...
                "chargingSessions": [
                    {
                        ...
                        "authorizationStart": {
                            "@id": CTRArray[0]["contract"]["id"],
                            "type": CTRArray[0]["contract"]["type"],
                            "timestamp": this.moment.unix(CTRArray[0]["contract"]["timestampLocal"]["timestamp"]).utc().utcOffset(CTRArray[0]["contract"]["timestampLocal"]["localOffset"] +
            ...
            for (var _measurement of CTRArray) {
                _CTR["chargingSessions"][0]["measurements"][0]["values"].push({
                    "timestamp": this.moment.unix(_measurement["measuredValue"]["timestampLocal"]["timestamp"]).utc().utcOffset(_measurement["measuredValue"]["timestampLocal"]["localOffset"] +
...
//# sourceMappingURL=chargeIT.js.map